                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Elija el grupo donde desea trabajar</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form" method="POST" action="<?php //url('login/first') ?>">
                                ...
                                <fieldset>
                                    ...
                                    <button type="submit" class="btn btn-lg btn-primary btn-block">Elegir <i class="fa fa-arrow-circle-o-right"></i></button>
                                    <a href="<?php destruir_sesion() ?>" class="btn btn-lg btn-warning btn-block">Salir <i class="fa fa-arrow-circle-o-left"></i></a>
                                </fieldset>
                            </form>
                            <br>
<?php
